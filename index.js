(function (global, factory) {
            ...
            flowChildren.forEach(function (item) {
              ...
              if (isDirectionRow) {
                if (alignSelf === 'flexStart' || alignSelf === 'flex-start') ; else if (alignSelf === 'center') {
                  ...
                  if (height[1] === AUTO$5) {
                    var old = item.height;
                    var v = item.__height = _computedStyle4[HEIGHT$5] = maxCross - marginTop - marginBottom - paddingTop - paddingBottom - borderTopWidth - borderBottomWidth;
                    var d = v - old;
                    item.__clientHeight += d;
                    item.__outerHeight += d;
                  }
            ...
            flowChildren.forEach(function (item) {
              ...
              if (isDirectionRow) {
                if (alignSelf === 'flexStart' || alignSelf === 'flex-start') ; else if (alignSelf === 'center') {
                  ...
                  if (height[1] === AUTO$5) {
                    var old = item.height;
                    var v = item.__height = item.__height = _computedStyle6[HEIGHT$5] = maxCross - marginTop - marginBottom - paddingTop - paddingBottom - borderTopWidth - borderBottomWidth;
                    var d = v - old;
                    item.__clientHeight += d;
                    item.__outerHeight += d;
                  }
  ...
  var Img$1 = /*#__PURE__*/function (_Dom) {
    ...
    _createClass(Img, [{
      ...
      value: function __loadAndRefresh(loadImg, root, ctx, placeholder, computedStyle, width, height) {
        var self = this;
      ...
      value: function updateSrc(v, cb) {
        ...
        if (v === loadImg.src || !v && loadImg.error) {
          ...
          loadImg.error = true;
          var res = {};
          res[UPDATE_NODE$2] = this;
          res[UPDATE_FOCUS$1] = o$2.REFLOW;
          res[UPDATE_IMG] = true;
          res[UPDATE_CONFIG$2] = this.__config;
