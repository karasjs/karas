(function (global, factory) {
  ...
  var o$1 = Object.assign({
     ...
     * @param lv
     */
    getDetailRepaintByLv: function getDetailRepaintByLv(style, lv) {
      if (lv === ENUM.NONE) {
        return ENUM.NONE;
      }
  ...
  var Cache = /*#__PURE__*/function () {
    ...
    _createClass(Cache, [{
      key: "__init",
      value: function __init(bbox, page, pos) {
        this.__bbox = bbox;
        this.__page = page;
        this.__pos = pos;
      ...
      value: function reset(bbox) {
        ...
        var res = Page.getInstance(Math.max(w + 2, h + 2));
  ...
  var Xom = /*#__PURE__*/function (_Node) {
    ...
    _createClass(Xom, [{
      ...
      key: "__calCache",
      value: function __calCache(renderMode, ctx, defs, parent, innerWidth, innerHeight, outerWidth, outerHeight, borderTopWidth, borderRightWidth, borderBottomWidth, borderLeftWidth, x1, x2, x3, x4, y1, y2, y3, y4) {
        var _this3 = this;
        ...
        var backgroundImage = __cacheStyle.backgroundImage;
      ...
      value: function render(renderMode, lv, ctx, defs) {
        ...
        var y4 = y3 + borderBottomWidth; // 防止cp直接返回cp嵌套，拿到真实dom的parent
      ...
      get: function get() {
        var sx = this.sx,
            ...
            display = _this$computedStyle5.display,
    ...
    _createClass(Dom, [{
      ...
      value: function render(renderMode, lv, ctx, defs) {
        ...
        var _res = res,
            ...
            filter = _res.filter; // canvas检查filter，无缓存时的绘制
        ...
        var root = this.root,
            ...
            position = _this$computedStyle.position,
            display = _this$computedStyle.display,
            visibility = _this$computedStyle.visibility; // 不显示的为了diff也要根据type生成
  ...
  function updateCp(cp, props, state) {
    ...
    while (sr instanceof Component$2) {
      sr = sr.shadowRoot;
    }
  ...
  var Root = /*#__PURE__*/function (_Dom) {
    ...
    _createClass(Root, [{
      ...
      value: function appendTo(dom) {
        ...
        this.__uuid = isNil$6(this.__dom.__uuid) ? uuid$1++ : this.__dom.__uuid;
        ...
        function checkInfluence(node, focus) {
          ...
          if (node.currentStyle.display === 'inline' || node.computedStyle.display === 'inline') {
            ...
            do {
              ...
              if (_parent2.currentStyle.position === 'absolute' || _parent2.computedStyle.position === 'absolute') {
                setLAYOUT(_parent2, reflowHash);
                return;
            ...
            } while (_parent2 && (_parent2.currentStyle.display === 'inline' || _parent2.computedStyle.display === 'inline')); // target至少是node的parent，如果固定尺寸提前跳出
    ...
    _createClass(Geom, [{
      ...
      value: function __preRender(renderMode, lv, ctx, defs) {
        ...
        if (__cacheStyle.strokeWidth === undefined) {
          ...
          } else if (_strokeWidth.unit === PERCENT$8) {
    ...
    _createClass(Line, [{
      ...
      value: function render(renderMode, lv, ctx, defs) {
        ...
        if (rebuild && renderMode === mode.SVG) {
          ...
          if (isMulti) {
            __cacheProps.x1.forEach(function (x1, i) {
              var x2 = __cacheProps.x2[i];
              var y1 = __cacheProps.y1[i];
              var y2 = __cacheProps.y2[i];
              var controlA = __cacheProps.controlA[i];
              var controlB = __cacheProps.controlB[i];
              var start = __cacheProps.start[i];
              var end = __cacheProps.end[i];
              var curve = curveNum(controlA, controlB);

              if (start !== 0 || end !== 1) {
                var _getNewPoint = getNewPoint(x1, y1, x2, y2, controlA, controlB, curve, start, end, __cacheProps.len);
                ...
                x2 = _getNewPoint2[2];
                y2 = _getNewPoint2[3];
                controlA = _getNewPoint2[4];
                controlB = _getNewPoint2[5];
              }
            ...
            if (start !== 0 || end !== 1) {
              var _getNewPoint3 = getNewPoint(_x, _y, _x2, _y2, _controlA, _controlB, curve, start, end, __cacheProps.len);
              ...
              _x2 = _getNewPoint4[2];
              _y2 = _getNewPoint4[3];
              _controlA = _getNewPoint4[4];
              _controlB = _getNewPoint4[5];
            }

            d = painter.svgLine(_x, _y, _x2, _y2, _controlA, _controlB, curve);
          }
          ...
          if (strokeWidth > 0) {
            ...
            if (isMulti) {
              __cacheProps.x1.forEach(function (x1, i) {
                ...
                if (start !== 0 || end !== 1) {
                  var _getNewPoint5 = getNewPoint(x1, y1, x2, y2, controlA, controlB, curve, start, end, __cacheProps.len);
                  ...
                  x2 = _getNewPoint6[2];
                  y2 = _getNewPoint6[3];
                  controlA = _getNewPoint6[4];
                  controlB = _getNewPoint6[5];
                }
              ...
              var _x3 = __cacheProps.x1,
                  _y3 = __cacheProps.y1,
                  _x4 = __cacheProps.x2,
                  _y4 = __cacheProps.y2,
                  _controlA2 = __cacheProps.controlA,
                  _controlB2 = __cacheProps.controlB;

              if (start !== 0 || end !== 1) {
                var _getNewPoint7 = getNewPoint(_x3, _y3, _x4, _y4, _controlA2, _controlB2, _curve, start, end, __cacheProps.len);
                ...
                _x4 = _getNewPoint8[2];
                _y4 = _getNewPoint8[3];
                _controlA2 = _getNewPoint8[4];
                _controlB2 = _getNewPoint8[5];
              }

              painter.canvasLine(ctx, _x3, _y3, _x4, _y4, _controlA2, _controlB2, _curve);
            }
      ...
      value: function render(renderMode, lv, ctx, defs) {
        ...
        if (rebuild) {
          ...
          if (isMulti) {
            ...
            __cacheProps.len = getLength(_list, isMulti);
