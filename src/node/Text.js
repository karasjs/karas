...
class Text extends Node {
  ...
  updateContent(s, cb) {
    ...
    this.__content = s;
    this.__root.__addUpdate(this.__domParent, null, level.REFLOW, false, false, false, false, false, cb);
  }
  ...
  remove(cb) {
    ...
    root.__addUpdate(this, null, level.REFLOW, false, true, false, false, false, cb);
  }
