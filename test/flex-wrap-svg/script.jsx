let o = karas.render(
  <svg width="360" height="360">
    ...
    <div style={{position:'absolute',left:200,top:150,display:'flex',flexWrap:'wrap-reverse',width:70,height:70,background:'#CCC'}}>
      <span style={{width:30,background:'#F00'}}>2</span>
      <span style={{width:30,background:'#0F0'}}>3</span>
      <span style={{width:30,background:'#00F'}}>4</span>
      <span style={{width:30,background:'#FF0'}}>5</span>
    ...
    <div style={{position:'absolute',left:200,top:225,display:'flex',flexWrap:'wrap-reverse',width:70,height:70,background:'#CCC',alignContent:'center'}}>
      <span style={{width:30,background:'#F00'}}>2</span>
      <span style={{width:30,background:'#0F0'}}>3</span>
      <span style={{width:30,background:'#00F'}}>4</span>
      <span style={{width:30,background:'#FF0'}}>5</span>
