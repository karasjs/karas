let o = karas.render(
  <webgl width="360" height="360">
    <div style={{position:'absolute',left:20,top:20,width:100,height:100,background:'#999',transform:'perspective(500)rotateY(40)'}}>
    ...
    <div style={{position:'absolute',left:220,top:20,width:100,height:100,perspective:500}}>
      <div style={{width:100,height:100,background:'#999',perspective:500,
